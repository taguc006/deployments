...
Variable *variableList[] = {
    ...
    new BoschBME280_Humidity(&bme280, "ce5756f1-224d-46f2-b18e-815ff4e0feb2"),
    new BoschBME280_Pressure(&bme280, "6432c166-3ba0-4b59-9597-c9bb1558fdc4"),
    ...
    new ProcessorStats_Batt(&mayfly, "baa55568-e4ad-4114-aa70-5d4a41652ddd"),
    new MaximDS3231_Temp(&ds3231, "2fb1f21c-c8b4-43f1-a87e-c06196cf951f"),
...
// ==========================================================================
const char *registrationToken = "127c29cd-d5ff-49a4-8183-21b46d612116";   // Device registration token
const char *samplingFeature = "33e8837a-afea-4c0f-b702-d127919657d2";     // Sampling feature UUID
